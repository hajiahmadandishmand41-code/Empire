...
const modulesByLocale: Record<AppLocale, Messages[]> = {
  fa: [faAuthForm, faResetPassword, faSearchUi, faAccountNav, faMetadata, faSiteUi],
  en: [enAuthForm, enResetPassword, enSearchUi, enAccountNav, enMetadata, enSiteUi],
  ps: [psAuthForm, psResetPassword, psSearchUi, psAccountNav, psMetadata, psSiteUi],
};
