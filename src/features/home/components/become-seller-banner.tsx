  ...
  return (
    <section className="mx-auto max-w-screen-xl px-3 sm:px-6">
      <div className="flex items-center justify-between gap-4 rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-50 via-white to-rose-50 px-4 py-4 shadow-sm dark:border-indigo-900/40 dark:from-indigo-950/30 dark:via-gray-950 dark:to-rose-950/20 sm:px-6">
        ...
        <Link href="/seller/apply#seller-application" className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-gray-900 px-3.5 py-2.5 text-xs font-bold text-white transition-transform hover:-translate-y-0.5 dark:bg-white dark:text-gray-900"><span>{copy.cta}</span><ArrowLeft className="h-3.5 w-3.5 rtl:rotate-180" /></Link>
      </div>
    </section>
  );
}
