...
function fallbackSlides(locale: string): VisualSlide[] {
  const fa: VisualSlide[] = [
    { id: 'local', kind: 'visual', title: 'محصولات وطنی', subtitle: 'حمایت از تولید ملی با انتخاب‌های باکیفیت و اصیل.', ctaLabel: 'مشاهده محصولات', href: '/traditional', theme: 'from-rose-100 via-pink-50 to-orange-100 dark:from-rose-950 dark:via-slate-950 dark:to-amber-950', icon: Sparkles },
    { id: 'home', kind: 'visual', title: 'محصولات خانه و زندگی', subtitle: 'برای خانه‌ای زیباتر و خریدی کاربردی‌تر، انتخاب‌های تازه را ببینید.', ctaLabel: 'خرید برای خانه', href: '/categories', theme: 'from-amber-100 via-yellow-50 to-lime-100 dark:from-amber-950 dark:via-slate-950 dark:to-lime-950', icon: Home },
    { id: 'stores', kind: 'visual', title: 'فروشگاه‌های ایشاپ', subtitle: 'فروشگاه‌های معتبر و فروشندگان را یکجا کشف کنید.', ctaLabel: 'مشاهده فروشگاه‌ها', href: '/stores', theme: 'from-violet-100 via-fuchsia-50 to-purple-100 dark:from-violet-950 dark:via-slate-950 dark:to-purple-950', icon: Store },
    { id: 'discounts', kind: 'visual', title: 'تخفیف‌های ویژه', subtitle: 'فقط پیشنهادهایی با تخفیف واقعی بیشتر از ۲۰٪ در این بخش.', ctaLabel: 'مشاهده تخفیف‌ها', href: '/discounts', theme: 'from-emerald-100 via-teal-50 to-cyan-100 dark:from-emerald-950 dark:via-slate-950 dark:to-cyan-950', icon: Tags },
    { id: 'discover', kind: 'visual', title: 'کشف بهترین‌ها', subtitle: 'پیشنهادهای هوشمند بر اساس محبوبیت، تازگی و سلیقه شما.', ctaLabel: 'شروع کشف', href: '/discover', theme: 'from-sky-100 via-blue-50 to-indigo-100 dark:from-sky-950 dark:via-slate-950 dark:to-indigo-950', icon: Compass },
  ];
  ...
  return (
    <section className="mx-auto max-w-screen-xl px-3 pt-3 sm:px-6 sm:pt-5" aria-label={labels.aria}>
      <div className="group relative overflow-hidden rounded-[24px] border border-border bg-card shadow-premium" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)} onFocus={() => setPaused(true)} onBlur={() => setPaused(false)} onPointerDown={onPointerDown} onPointerUp={onPointerUp}>
        {slide.kind === 'image' ? (
          <div className="relative h-[258px] sm:h-[340px]">
          ...
          <div className={cn('relative h-[258px] overflow-hidden bg-gradient-to-br p-4 shadow-inner dark:text-white sm:h-[340px] sm:p-8', slide.theme)} dir={isEnglish ? 'ltr' : 'rtl'}>
            <div className="absolute -end-24 -top-24 h-64 w-64 rounded-full bg-white/45 blur-3xl dark:bg-white/10" aria-hidden="true" />
            <div className="absolute -start-20 -bottom-28 h-64 w-64 rounded-full bg-white/35 blur-3xl dark:bg-white/5" aria-hidden="true" />
            <div className="absolute inset-y-0 end-0 hidden w-1/3 bg-gradient-to-l from-white/20 to-transparent sm:block" aria-hidden="true" />
            <div className="relative flex h-full items-center"><div className="max-w-[86%] sm:max-w-2xl">
              <div className="mb-2 inline-flex items-center gap-1.5 rounded-full border border-black/10 bg-white/70 px-3 py-1.5 text-[10px] font-extrabold text-slate-800 shadow-sm backdrop-blur-sm dark:border-white/15 dark:bg-white/10 dark:text-white"><Sparkles className="h-3 w-3" />ایشاپ</div>
