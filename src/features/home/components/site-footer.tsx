import {
  Phone, Mail, MapPin, Instagram, Twitter, Send, Youtube, ChevronLeft,
  ShieldCheck, Truck, RotateCcw, CreditCard, Headphones,
} from 'lucide-react';
...
export function SiteFooter() {
  ...
  const navLinks = [
    ...
    { label: t('traditionalProducts'), href: '/traditional' },
    { label: t('allCategories'), href: '/shop?view=categories' },
  ];
  const supportLinks = [
    { label: t('buyingGuide'), href: '/faq' },
  ...
  const legalLinks = [
    ...
    { label: t('privacy'), href: '/terms' },
    { label: t('contact'), href: '/contact' },
    { label: t('returnRules'), href: '/returns' },
  ];
