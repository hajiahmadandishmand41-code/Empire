...
export function SkeletonCard() {
  return <div className="w-[calc((100%-1rem)/3)] max-w-[220px] flex-none overflow-hidden rounded-2xl border border-lime-300/60 bg-white/90 shadow-sm dark:border-slate-800 dark:bg-slate-900/90 sm:w-[calc((100%-1.25rem)/3)] sm:max-w-[230px]" aria-hidden="true"><div className="aspect-[3/2] animate-pulse bg-lime-100 dark:bg-slate-800" /><div className="space-y-1.5 p-2.5 sm:p-3"><div className="h-2.5 w-14 animate-pulse rounded bg-muted" /><div className="h-3 w-full animate-pulse rounded bg-muted" /><div className="h-3 w-3/4 animate-pulse rounded bg-muted" /><div className="h-8 w-8 animate-pulse rounded-full bg-muted" /></div></div>;
}
