    ...
    <header className="sticky top-0 z-50 w-full" role="banner">
      <div className="overflow-hidden border-b border-orange-300/20 bg-gradient-to-r from-[#a94810] via-[#c56319] to-[#91350f] text-white">
        <div className="flex min-h-8 items-center overflow-hidden">
          <div className="whitespace-nowrap text-[10px] font-bold tracking-wide sm:text-[11px] animate-[marquee_18s_linear_infinite]">
            <span className="mx-8 inline-flex items-center gap-1.5"><Truck className="h-3.5 w-3.5 text-amber-200" aria-hidden="true" />{topMessage}</span>
