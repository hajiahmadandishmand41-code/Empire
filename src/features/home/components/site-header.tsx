        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6">
          <div className="flex min-h-8 items-center justify-between gap-3 py-1.5">
            <div className="flex min-w-0 items-center gap-1.5 text-[11px] text-emerald-300">
              ...
              <span className="truncate">{t('shippingBanner')}</span>
            </div>
            ...
            <div className="hidden items-center gap-1.5 text-[11px] text-muted-foreground md:flex">
              ...
              <a href="tel:+93798228441" dir="ltr" className="rounded transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" aria-label={t('hotlineAria')}>+93 798 228 441</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-screen-xl px-3 sm:px-6">
          <div className="flex min-h-[3.75rem] items-center gap-2 sm:min-h-[4.5rem] sm:gap-4">
            <Link href="/" className="group flex shrink-0 items-center gap-2 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary" aria-label={t('logoAria')}>
              <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-primary shadow-sm shadow-primary/20 transition-transform duration-150 group-hover:scale-[1.02] sm:h-10 sm:w-10" aria-hidden="true">
            ...
            <Link href="/shop" className="hidden shrink-0 items-center gap-2 rounded-xl border border-border bg-secondary px-3.5 py-2 text-xs font-bold text-secondary-foreground transition-colors hover:border-primary/30 hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring lg:flex">
