    ...
    try {
      ...
      if (!response.ok || !data.ok) {
        ...
        const messages: Record<string, string> = {
          INVALID_CREDENTIALS: t('invalidCredentials'), USER_EXISTS: t('userExists'), TOO_MANY_REQUESTS: t('tooManyRequests'),
          VALIDATION_ERROR: t('validationError'), service_unavailable: t('serviceUnavailable'),
        };
