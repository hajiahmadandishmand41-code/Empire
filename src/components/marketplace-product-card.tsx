          ...
          >
            {product.images?.[0]?.src ? (
              <Image
                ...
                fill
                sizes={isList ? '128px' : '(max-width: 639px) 46vw, (max-width: 1024px) 30vw, (max-width: 1536px) 22vw, 260px'}
                loading="lazy"
      ...
      <div className={cn('min-w-0', isList ? 'flex min-w-0 flex-1 flex-col justify-between gap-2 p-3' : 'flex min-h-[154px] flex-1 flex-col gap-2.5 p-3')}>
        ...
        <div className="flex min-w-0 items-center justify-between gap-2 rounded-xl bg-muted/50 px-2.5 py-2">
          <div className="min-w-0">
            ...
            <span className={cn('block truncate font-black leading-none tracking-tight', discountPct > 0 ? 'text-price-current' : 'text-foreground', isList ? 'text-xs' : 'text-sm sm:text-base')}>
