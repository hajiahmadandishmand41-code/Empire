...
const copy = {
  fa: { title: 'جستجو', found: 'نتیجه', placeholder: 'محصول، برند یا فروشگاه را جستجو کنید', submit: 'جستجو', filters: 'فیلترها', clear: 'حذف فیلترها', category: 'دسته‌بندی', seller: 'فروشنده', brand: 'برند', min: 'حداقل قیمت', max: 'حداکثر قیمت', stock: 'فقط موجودها', discount: 'فقط تخفیف‌دارها', rating: 'حداقل امتیاز', sort: 'مرتب‌سازی', apply: 'اعمال', empty: 'نتیجه‌ای پیدا نشد', emptyText: 'عبارت دیگری را امتحان کنید یا فیلترها را تغییر دهید.', retry: 'جستجوی جدید', previous: 'قبلی', next: 'بعدی', page: 'صفحه' },
  ps: { title: 'لټون', found: 'پایلې', placeholder: 'محصول، برانډ یا پلورنځی ولټوئ', submit: 'لټون', filters: 'فلټرونه', clear: 'فلټرونه پاک کړئ', category: 'وېشنیزه', seller: 'پلورونکی', brand: 'برانډ', min: 'لږ تر لږه بیه', max: 'تر ټولو لوړه بیه', stock: 'یوازې شته', discount: 'یوازې تخفیف', rating: 'لږ تر لږه درجه', sort: 'ترتیب', apply: 'پلي کول', empty: 'پایله ونه موندل شوه', emptyText: 'بله کلیمه یا فلټر وکاروئ.', retry: 'نوی لټون', previous: 'مخکینی', next: 'بل', page: 'پاڼه' },
  en: { title: 'Search', found: 'results', placeholder: 'Search products, brands or stores', submit: 'Search', filters: 'Filters', clear: 'Clear filters', category: 'Category', seller: 'Seller', brand: 'Brand', min: 'Min price', max: 'Max price', stock: 'In stock only', discount: 'On sale only', rating: 'Minimum rating', sort: 'Sort', apply: 'Apply', empty: 'No results found', emptyText: 'Try another query or change your filters.', retry: 'New search', previous: 'Previous', next: 'Next', page: 'Page' },
} as const;
const sortLabels = {
