...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, type: 'website', url: canonicalUrl, images: product.images?.[0]?.src ? [{ url: product.images[0].src, alt: product.name }] : undefined },
  };
}
