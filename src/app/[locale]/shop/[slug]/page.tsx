...
/**
 * Product detail route — `/[locale]/shop/[slug]`.
 * Stage 5: Full OG/Twitter metadata, canonical URL, hreflang alternates.
 */
export async function generateMetadata({
  ...
  const description = product.shortDescription ?? `خرید ${product.name} از Empire Shop`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        fa: `${SITE_URL}/fa/shop/${slug}`,
        ps: `${SITE_URL}/ps/shop/${slug}`,
        en: `${SITE_URL}/en/shop/${slug}`,
      },
    },
    openGraph: {
      title,
