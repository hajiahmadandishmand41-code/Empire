...
- Commit: f54f8a042949539894400f1c6e350384049b9217
...
[2/5] [seller-e2e] › tests/seller-authenticated-e2e.spec.mjs:18:1 › seller can authenticate and open every seller-center route
  1) [seller-e2e] › tests/seller-authenticated-e2e.spec.mjs:18:1 › seller can authenticate and open every seller-center route 
    ...
    Error: strict mode violation: locator('#main') resolved to 2 elements:
        ...
        2) <main id="main" class="flex-1 p-4 sm:p-6">…</main> aka locator('main').filter({ hasText: 'ایشاپدر حال باز کردن صفحه…' })
...
[2/7] [seller-e2e] › tests/seller-center-deep-e2e.spec.mjs:39:3 › Seller Center — deep end-to-end › authentication and every seller route are healthy
  1) [seller-e2e] › tests/seller-center-deep-e2e.spec.mjs:39:3 › Seller Center — deep end-to-end › authentication and every seller route are healthy 
    ...
    Error: runtime errors on /fa/seller/inventory
...
{"ts":"2026-09-06T12:39:21.356Z","level":"info","msg":"seller.product.created","productId":"cmtpstkp2000410c6hlec72wt","sellerId":"cmtpsrjsh0000wzvdvpskly8r","slug":"mhswl-tst-frwshndh-e2e-1788698360897","imageCount":0}
{"ts":"2026-09-06T12:39:30.899Z","level":"info","msg":"seller.product.created","productId":"cmtpsts27000b10c6rzz5s5ux","sellerId":"cmtpsrjsh0000wzvdvpskly8r","slug":"e2e-seller-product-1788698370876","imageCount":0}
{"ts":"2026-09-06T12:39:31.538Z","level":"info","msg":"seller.product.deleted","productId":"cmtpsts27000b10c6rzz5s5ux","sellerId":"cmtpsrjsh0000wzvdvpskly8r","mediaCount":3}
